...
import 'category_bnav_view_model.dart';

class CategoryBnavView extends StatelessWidget {
  const CategoryBnavView({Key key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<CategoryBnavViewModel>.reactive(
      viewModelBuilder: () => CategoryBnavViewModel(),
        ...
        body: SafeArea(
          ...
          child: NetworkSensitive(
            currentWidget: SingleChildScrollView(
              key: PageStorageKey("CategoryWidgetList"),
              child: Stack(
                children: <Widget>[
                  Container(
                    height: 230,
...
class CategoryWidgetList extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
    return Container(
...
class SearchBnavCategory extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
...
class SubCategoryGridView extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
...
class BrandsGridView extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
    return GridView.builder(
      physics: NeverScrollableScrollPhysics(),
...
class CategoryList extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
    return Container(
      width: MediaQuery.of(context).size.width,
...
class CategoryTitle extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
    return Container(
      width: MediaQuery.of(context).size.width,
...
class SubCategoryTitle extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
    return Container(
      width: MediaQuery.of(context).size.width,
...
class BrandsTitle extends ViewModelWidget<CategoryBnavViewModel> {
  @override
  Widget build(BuildContext context, CategoryBnavViewModel viewModel) {
    return Container(
      width: MediaQuery.of(context).size.width,
