...
import 'package:quickstart_flutter_ecom_code_02_20_1/ui/views/product_grid_list/product_grid_list_view_model.dart';
import 'package:stacked/stacked.dart';
import 'package:badges/badges.dart';

class ProductGridListView extends StatelessWidget {
  final String slugId;
  final String categoryName;
  ProductGridListView({this.slugId, this.categoryName, Key key})
      : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<ProductGridListViewModel>.reactive(
      viewModelBuilder: () => ProductGridListViewModel(),
      onModelReady: (model) => model.loadData(slugId, categoryName),
...
class EmptyList extends ViewModelWidget<ProductGridListViewModel> {
  @override
  Widget build(BuildContext context, ProductGridListViewModel viewModel) {
    return Column(
...
class ProductGridWidgetList extends ViewModelWidget<ProductGridListViewModel> {
  @override
  Widget build(BuildContext context, ProductGridListViewModel viewModel) {
...
class ProductScrollList extends ViewModelWidget<ProductGridListViewModel> {
  @override
  Widget build(BuildContext context, ProductGridListViewModel viewModel) {
    return Container(
      ...
      child: PagedGridView<int, UniversalProduct>(
          ...
          builderDelegate: PagedChildBuilderDelegate<UniversalProduct>(
                  ...
                  child: Container(
                    child: Stack(
                      children: [
                            ...
                            children: [
                              ...
                              Visibility(
                                ...
                                child: Container(
                                  ...
                                  child: viewModel.productGridListResponse !=
                                              null &&
                        ...
                        Positioned(
                          left: 0.0,
                          top: MediaQuery.of(context).size.height / 3.5, //250,
                          child: Container(
...
class OfferContainer extends ViewModelWidget<ProductGridListViewModel> {
  final index;
...
class AddToWishList extends ViewModelWidget<ProductGridListViewModel> {
  final index;
  final item;
...
class BannerOnGridItem extends ViewModelWidget<ProductGridListViewModel> {
  final index;
...
class FilterOptionsContainer extends ViewModelWidget<ProductGridListViewModel> {
  @override
  Widget build(BuildContext context, ProductGridListViewModel viewModel) {
    return Container(
      ...
      child: Row(children: <Widget>[
        ...
        Spacer(),
        Text(
          viewModel.productScrollGridList != null && !viewModel.isBusy
...
class BannerOnProduct extends ViewModelWidget<ProductGridListViewModel> {
  // final index;
